...
(function () {
  ...
  force('String', String, [
    ...
    'reduce',
    'reduceRight',
  ])('Number', Number, ['toExponential', 'toFixed', 'toLocaleString', 'toPrecision'])('Function', Function, [
    'apply',
    'call',
    'bind',
...
(function () {
  ...
  local.search = function (context, expression, append, first) {
    ...
    if (typeof expression == 'string') {
      ...
      // other junk
      return found;
    } /*<nth-pseudo-selectors>*/ // cache elements for the nth selectors

    /*<pseudo-selectors>*/ this.posNTH = {};
    this.posNTHLast = {};
    this.posNTHType = {};
    this.posNTHTypeLast = {}; /*</pseudo-selectors>*/ // if append is null and there is only a single selector with one expression use pushArray, else use pushUID

    /*</nth-pseudo-selectors>*/ this.push =
  ...
  /*</nth-pseudo-selectors>*/ local.pushArray = function (node, tag, id, classes, attributes, pseudos) {
...
(function () {
  ...
  Swiff.remote = function (obj, fn) {
    var rs = obj.CallFunction(
      '<invoke name="' + fn + '" returntype="javascript">' + __flash__argumentsToXML(arguments, 2) + '</invoke>'
    );
    return eval(rs);
  };
})();
